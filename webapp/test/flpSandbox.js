		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Simple Form",
									"targetURL": "#simpleformsimpleform-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"simpleformsimpleform-display": {
								"semanticObject": "simpleformsimpleform",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=simpleform.simpleform",
									"url": sap.ui.require.toUrl("simpleform/simpleform")
								}
							}
						}
					}
